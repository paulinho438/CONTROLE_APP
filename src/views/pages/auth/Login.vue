        ...
        <div class="z-1 flex flex-column align-items-center justify-content-center">
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="z-1 w-full surface-card py-8 px-5 sm:px-8" style="border-radius: 53px">
                    ...
                    <div class="z-1">
                        <label for="usuario" class="block text-900 text-xl font-medium mb-2">Usuário</label>
                        <InputText v-model="usuario" id="usuario" type="text" class="w-full md:w-30rem mb-5" placeholder="Digite seu usuário" :disabled="loadingLogin" />
